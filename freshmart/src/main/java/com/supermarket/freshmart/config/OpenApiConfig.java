...
public class OpenApiConfig {
    ...
    public OpenAPI defineApi() {
        ...
        server.setDescription("Supermarket management system");

        // Define API info
        Info info = new Info().title("Supermarket management system").version("1.0").description("Swagger Configuration phase");
